...
| **Actions (OpenAPI)** | `@kernel_function` Python plugin classes |
...
| [`openapi/city-services-api.json`](./openapi/city-services-api.json) | OpenAPI spec to upload as an Action |
